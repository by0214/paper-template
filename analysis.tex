...
\(\tilde R_{i,t}\)-based local filtering; and
...
Second, adding \(\tilde R_{i,t}\)-based filtering further stabilizes training
...
\(\tilde R_{i,t}\) rather than an alternative LLM-consistency filter?
...
By contrast, \(\tilde R_{i,t}\) explicitly asks whether removing the current
step, together with its strongest short-range interactions, changes the
...
This comparison clarifies why the final method uses \(\tilde R_{i,t}\).
