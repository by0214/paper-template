...
module.
The question-boundary state improves step alignment, pairwise counterfactual
filtering reduces local label noise, and the global prior adds robustness
against context-dependent fluctuations in step value.
