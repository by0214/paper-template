...
$x_{i,-1}$ denotes a manually defined baseline for the \texttt{question\_end}
representation,
...
Collectively, these results substantiate the utility of our non-parametric voting estimator. By surfacing robust, cross-sample statistical constraints, the global signal provides a highly discriminative empirical prior that complements the intra-trajectory marginal contributions ($\delta_{\text{local}}$).