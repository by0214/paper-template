...
\newcommand{\todo}[2][]{%
    \marginpar{\raggedright\footnotesize\color{red} TODO: #2}}
...
% tables
\definecolor{TableBandGray}{gray}{0.94}
...
\newcommand{\XSolidBrunsh}{\raisebox{0.15ex}{\scalebox{0.9}{\(\boldsymbol{\times}\)}}}
