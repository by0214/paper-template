...
A multi-step reasoning trajectory can be viewed as a cooperative game in
which reasoning steps are the players and the final trajectory reward is the
shared payoff.
Step credit assignment is then the problem of allocating that shared payoff
back to individual steps.
...
This makes Shapley values attractive: they allocate shared payoff by
marginal contribution and therefore provide a natural starting point for
turning sparse final rewards into step-level credit.
